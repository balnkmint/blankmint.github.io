...
export class Game {
     ...
     * @param {string} key
     */
    set_direction_from_key(key) {
        const ptr0 = passStringToWasm0(key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.game_set_direction_from_key(this.__wbg_ptr, ptr0, len0);
    }
    toggle_pause() {
     ...
     */
    render(ctx) {
        wasm.game_render(this.__wbg_ptr, ctx);
    }
    /**
     * @returns {number}
     */
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_log_edc1be40856c6db5 = function(arg0, arg1) {
