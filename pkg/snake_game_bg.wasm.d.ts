...
export const game_set_direction_from_key: (a: number, b: number, c: number) => void;
export const game_toggle_pause: (a: number) => void;
export const game_is_paused: (a: number) => number;
export const game_render: (a: number, b: any) => void;
